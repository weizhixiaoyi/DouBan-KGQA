...
(1, NULL, 'USC Information Sciences Institute', '4676 Admirality Way', 'Marina Del Rey', NULL, 'United States', 'http://trellis.semanticweb.org/expect/weixin/semanticweb/iswc02_trellis.pdf#ISI', NULL, NULL),
...
(1, 'Full_Professor', 'Yolanda', 'Gil', NULL, 'gil@isi.edu', 'http://www.isi.edu/~gil', '310-448-8794', 'http://trellis.semanticweb.org/expect/weixin/semanticweb/iswc02_trellis.pdf#Yolanda Gil', 'http://www.isi.edu/~gil/y.g.v4.tiff'),
(2, NULL, 'Varun', 'Ratnakar', NULL, 'varunr@isi.edu', 'http://www.isi.edu/~varunr', NULL, 'http://trellis.semanticweb.org/expect/weixin/semanticweb/iswc02_trellis.pdf#Varun Ratnakar', NULL),
(3, 'Researcher', 'Jim', 'Blythe', NULL, 'blythe@isi.edu', 'http://www.isi.edu/~varunr', NULL, 'http://trellis.semanticweb.org/expect/weixin/semanticweb/iswc02_trellis.pdf#Jim Blythe', NULL),
